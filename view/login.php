...
<head>
    ...
    <style type="text/css">
        ...
        .link {text-decoration: none; color: #2C73A8; font-size: 14px; font-weight: bold; text-align: right;}
    </style>
        ...
        <div id="direito">
            ...
            <div id="direito_reg" name="novo" style="display:none">
                <form action="login.php" method="post" name="Formulario2">
                    ...
                    <input type="submit" id="cancelar" name="cancelar" value="Cancelar" class="btn1" onclick="cancelaInputsRequired()">
                    <input type="submit" id="ok" name="OK" value="OK" class="btn1" style="display:none" onclick="cancelaInputsRequired()">   
                </form>
